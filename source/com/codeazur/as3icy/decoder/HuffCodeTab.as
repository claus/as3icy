package com.codeazur.as3icy.decoder
{
	...
	{
		protected static const MXOFF:uint = 250;
		protected static const HTN:uint = 34;

		protected var tablename0:String = ' '; // string, containing table_description
		protected var tablename1:String = ' '; // string, containing table_description
		protected var tablename2:String = ' '; // string, containing table_description
		
		protected var xlen:int; // max x-index+
		protected var ylen:int; // max y-index+
		protected var linbits:int; // number of linbits
		protected var linmax:int; // max number to be stored in linbits
		protected var ref:int; // a positive value indicates a reference
		protected var table:Array; // pointer to array[xlen][ylen]
		protected var hlen:Array; // pointer to array[xlen][ylen]
		protected var val:Array; // decoder tree
		protected var treelen:int; // length of decoder tree

		public function HuffCodeTab(s:String, xlen:int, ylen:int, linbits:int, linmax:int, ref:int, table:Array, hlen:Array, val:Array, treelen:int)
		{
		...
		*/
		...
		protected static var ValTab0:Array = [
			[0,0]
		];
		
		protected static var ValTab1:Array = [
			[2,1], [0,0], [2,1], [0,16], [2,1], [0,1], [0,17]
		];
		
		protected static var ValTab2:Array = [
			[2,1], [0,0], [4,1], [2,1], [0,16], [0,1], [2,1], [0,17], [4,1], [2,1], 
			[0,32], [0,33], [2,1], [0,18], [2,1], [0,2], [0,34]
		];

		protected static var ValTab3:Array = [
			[4,1], [2,1], [0,0], [0,1], [2,1], [0,17], [2,1], [0,16], [4,1], [2,1], 
			[0,32], [0,33], [2,1], [0,18], [2,1], [0,2], [0,34]
		];
		
		protected static var ValTab4:Array = [
			[0,0]
		];
		
		protected static var ValTab5:Array = [
		...
		protected static var ValTab6:Array = [
		...
		protected static var ValTab7:Array = [
		...
		protected static var ValTab8:Array = [
		...
		protected static var ValTab9:Array = [
		...
		protected static var ValTab10:Array = [
		...
		protected static var ValTab11:Array = [
		...
		protected static var ValTab12:Array = [
		...
		protected static var ValTab13:Array = [
		...
		protected static var ValTab14:Array = [
			[0,0]
		];
		
		protected static var ValTab15:Array = [
		...
		protected static var ValTab16:Array = [
		...
		protected static var ValTab24:Array = [
		...
		protected static var ValTab32:Array = [
		...
		protected static var ValTab33:Array = [
		...
		public static var ht:Vector.<HuffCodeTab> = Vector.<HuffCodeTab>([
